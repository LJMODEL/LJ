...
public class FilmDateils_RemenBean_Adapter extends RecyclerView.Adapter<FilmDateils_RemenBean_Adapter.Viewholder> {
    List<FilmRecycler_RemenBean.ResultBean> result;
    private Context context;



    public FilmDateils_RemenBean_Adapter(List<FilmRecycler_RemenBean.ResultBean> result, Context context) {
        this.result = result;
    ...
    public void setOnClickLinsenter(setOnClick setonClick){
