...
public class FilmDateils_actionBean_Adapter extends RecyclerView.Adapter<FilmDateils_actionBean_Adapter.Viewholder> {
    private List<FilmRecycler_actionBean.ResultBean> result;
    private Context context;
    public FilmDateils_actionBean_Adapter(List<FilmRecycler_actionBean.ResultBean> result, Context context) {
        this.result = result;
        this.context = context;
    }
    @NonNull
    @Override
    public FilmDateils_actionBean_Adapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.movie_list_recy_item, null);
        FilmDateils_actionBean_Adapter.Viewholder viewholder = new FilmDateils_actionBean_Adapter.Viewholder(view);
        return viewholder;
    }

    @Override
    public void onBindViewHolder(@NonNull FilmDateils_actionBean_Adapter.Viewholder holder, final int position) {
        Glide.with(context)
    ...
    private FilmDateils_actionBean_Adapter.setOnClick setonClick;
    public void setOnClickLinsenter(FilmDateils_actionBean_Adapter.setOnClick setonClick){
