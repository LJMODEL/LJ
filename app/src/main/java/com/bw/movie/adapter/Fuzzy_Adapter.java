...
public class Fuzzy_Adapter extends RecyclerView.Adapter<Fuzzy_Adapter.Viewholder> {

    private List<Cinema_Fuzzy_Bean.ResultBean> list;
    private Context context;

    public Fuzzy_Adapter(List<Cinema_Fuzzy_Bean.ResultBean> list, Context context) {
        this.list = list;
